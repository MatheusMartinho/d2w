...
export class DistribuidoresComponent {
  ...
  stateInfo: { [key: string]: { nome: string, capital: string, description: string, img1: string, url: string} } = {
    ...
    "BR-BA": { nome: "Bahia", capital: "Salvador" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "",url:"https://www.etelmaster.com.br"},
    ...
    "BR-DF": { nome: "Distrito Federal", capital: "Brasília" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "",url:"https://www.etelmaster.com.br"},
    ...
    "BR-GO": { nome: "Goiás", capital: "/assets/images/logos/logo-horus.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/horus-website.png",url:"https://www.etelmaster.com.br"},
    ...
    "BR-RJ": { nome: "Rio de Janeiro", capital: "Rio de Janeiro" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "",url:"https://www.etelmaster.com.br"},
    ...
    "BR-SP": { nome: "São Paulo", capital: "/assets/images/logos/etelMasterLogo.jpg" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "",url:"https://www.etelmaster.com.br"},
