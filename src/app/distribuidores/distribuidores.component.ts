...
export class DistribuidoresComponent {
  ...
  stateInfo: { [key: string]: { nome: string, capital: string, description: string, img1: string, url: string} } = {
    ...
    "BR-AL": { nome: "Alagoas", capital: "/assets/images/logos/lemos-logo.png", description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/lemosWebsite.png",url:"https://www.lemostelecom.com.br"},
    ...
    "BR-BA": { nome: "Bahia", capital: "/assets/images/logos/pontoDaRedeLogo.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/pontoRedeWebsite.jpg",url:"https://pontodarede.com.br"},
    "BR-CE": { nome: "Ceará", capital: "/assets/images/logos/etelMasterLogo.jpg" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/horus-website.png",url:"https://www.etelmaster.com.br"},
    ...
    "BR-PB": { nome: "Paraíba", capital: "/assets/images/logos/lemos-logo.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/lemosWebsite.png",url:"https://www.lemostelecom.com.br"},
    // "BR-PR": { nome: "Paraná", capital: "Curitiba" ,description: "Clique nos demais estados do mapa para mais opções.",img1: ""},
    "BR-PE": { nome: "Pernambuco", capital: "/assets/images/logos/etelMasterLogo.jpg", description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/etelWebsite.png",url:"https://www.etelmaster.com.br"},
    "BR-PI": { nome: "Piauí", capital: "/assets/images/logos/lemos-logo.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/lemosWebsite.png",url:"https://www.lemostelecom.com.br"},
    ...
    "BR-RN": { nome: "Rio Grande do Norte", capital: "/assets/images/logos/logo-horus.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/horus-website.png",url:"https://www.etelmaster.com.br"},
    ...
    "BR-SE": { nome: " Sergipe", capital: "/assets/images/logos/lemos-logo.png" ,description: "Clique nos demais estados do mapa para mais opções.",img1: "/assets/images/lemosWebsite.png",url:"https://www.lemostelecom.com.br"},
